...
if(empty($_SESSION["cart"]) OR !isset($_SESSION["cart"])){
  echo "<script>alert('Cart is empty. Let's go shopping!');</script>";
		...
		<section class="ftco-section ftco-cart">
			<div class="container">
    			...
    			<div class="col-md-12 ftco-animate">
                    ...
                    <th> </th>
						    ...
						    <tbody>
						      ...
						      <tr class="text-center">
										...
										<td><img class="img-fluid" src="../admin/foto_produk/<?php echo $pecah['foto_produk']; ?>" width="150"></td>
                    ...
                    <td><a href="deletecart.php?id=<?php echo $id_produk ?>" class="btn btn-danger btn-xs">Delete</a></td>
									</tr><!-- END TR-->
									<?php endforeach ?>
						    </tbody>
							</table>
