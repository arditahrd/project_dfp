...
<html lang="en">
  ...
  <body>
    ...
    <!-- END nav -->
		...
		<div class="hero-wrap hero-bread" style="background-image: url('images/bg2.jpg');">
      <div class="container">
    	...
    	<div class="container-fluid">
    		<div class="row">
    			...
    			<div class="col-sm col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="../admin/foto_produk/<?php echo $perproduk['foto_produk']; ?>" alt="Colorlib Template">
    					</a>
    					<div class="text py-3 px-3">
    						...
    						<p class="bottom-area d-flex">
    							<a href="cart1.php?id=<?php echo $perproduk['id_produk']; ?>" class="add-to-cart"><span>Add to cart <i class="ion-ios-add ml-1"></i></span></a>
    						</p>
    					</div>
    				</div>
					</div>
