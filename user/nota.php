...
<html lang="en">
  ...
  <body>
	...
	<div class="hero-wrap hero-bread" style="background-image: url('images/nota.jpg');">
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-0 bread">Purchase Orders</h1>
...
<div class="row">
  ...
  <div class="col-md-4">
    ...
    Shipping Charges: Rp<?php echo number_format($detail['tarif']); ?><br>
    Shipping Address: <?php echo $detail['alamat_pengiriman'] ?>
  </div>
</div>
    ...
    <div class="row">
        <div class="col-md-7">
            <div class="alert alert-info">
                <p>
                Please make a payment of Rp<?php echo number_format($detail['total_pembelian']);
                ?> to <br>
                <strong>BANK BCA 123-45678 in the name of Dita.</strong><br>
